...
<head>
    ...
    <!-- Custom Stylesheet -->
    <link href="lendstyle.css" rel="stylesheet">
...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark me-3">
                ...
                <div class="collapse navbar-collapse" id="morebtn">
                    ...
                    <ul class="navbar-nav ms-auto px-4">
                        ...
                        <a class="nav-link" href="../About Us/about.html">Visit Us</a>
                        </li>
                        <li class="nav-item"></li>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="burgerbtn">
                    ...
                    <ul class="hovering navbar-nav fs-5 gap-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../Collection Page/collectionpage.html">Collections</a>
    ...
    <div class="donationtitle container mt-4 mx-0">
        <h1 class="ms-5 py-3">Lending Form</h1>
    </div>
        <form action="process_lending.php" method="POST" enctype="multipart/form-data" id="lendingForm">
        <input type="hidden" name="formType" value="lending"> <!-- Valid example with a set value -->
            ...
            <div class="form-group row align-items-center mt-4 gap-1">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control border-2 border-dark" id="firstName" name="firstName" placeholder="First Name"
                        required>
                </div>
                <div class="col-sm-5">
                    <input type="text" class="form-control border-2 border-dark" id="lastName" name="lastName" placeholder="Last Name"
                        required>
                </div>
            </div>
            ...
            <div class="form-group row align-items-center mt-4">
                <label for="email" class="col-sm-2 col-form-label fs-5"><b>Email</b> <span
                        class="text-danger">*</span></label>
                <div class="col-sm-5">
                    <input type="email" class="form-control border-2 border-dark" id="email" name="email"
    ...
    <div class="intro container p-5 my-4">
        <div class="lending-details container mt-4 mx-0">
            <h3>Lending Details</h3>

            <div class="form-group row align-items-center mt-4">
                <label for="loanDuration" class="col-sm-4 col-form-label fs-5"><b>Proposed duration of the loan?</b>
                    <span class="text-danger">*</span></label>
                <div class="col-sm-8">
                    <input type="text" class="form-control border-2 border-dark" id="loanDuration" name="loanDuration"
                        placeholder="Specific duration (ex. 5 years), Month yyyy - Month dd, yyyy" required>
                </div>
            </div>

            <div class="form-group row align-items-center mt-4">
                <label for="displayConditions" class="col-sm-4 col-form-label fs-5"><b>Specific conditions or
                        requirements for the display or handling of the artifact?</b> <span
                        class="text-danger">*</span></label>
                <div class="col-sm-8">
                    <input type="text" class="form-control border-2 border-dark" id="displayConditions" name="displayConditions" required>
                </div>
            </div>

            <div class="form-group row align-items-center mt-4">
                <label for="liabilityConcerns" class="col-sm-4 col-form-label fs-5"><b>Specific liability concerns or
                        requirements you have regarding the artifact?</b> <span class="text-danger">*</span></label>
                <div class="col-sm-8">
                    <input type="text" class="form-control border-2 border-dark" id="liabilityConcerns" name="liabilityConcerns" required>
                </div>
            </div>

            <div class="form-group row align-items-center mt-4">
                <label for="lendingReason" class="col-sm-4 col-form-label fs-5"><b>Reason for lending.</b> <span
                        class="text-danger">*</span></label>
                <div class="col-sm-8">
                    <input type="text" class="form-control border-2 border-dark" id="lendingReason" name="lendingReason" required>
                </div>
            </div>
        </div>
    ...
    <div class="intro container p-5 my-4">
        ...
        <div class="form-group row align-items-center  mt-4">
            <label for="artifactTitle" class="col-sm-3 col-form-label fs-5"><b>Title/Name of the Artifact.</b> <span
                    class="text-danger">*</span></label>
            <div class="col-sm-9">
                <input type="text" class="form-control border-2 border-dark" id="artifactTitle" name="artifactTitle"
        ...
        <div class="form-group row align-items-center mt-4">
            <label for="artifactDescription" class="col-sm-3 col-form-label fs-5"><b>Artifact Description</b> <span
                    class="text-danger">*</span></label>
            <div class="col-sm-9">
                <textarea class="form-control border-2 border-dark" id="artifactDescription" name="artifactDescription"
    ...
    <div class="wrapper">
        ...
        <div class="lowercontainer ms-5 pt-4">
            <div class="row d-flex">
                <div class="col-12">
                    <ul class="nav-links">
                        <li><a class="text-decoration-none" href="../Home/index.html">Home</a></li>
                        ...
                        <div class="vr border border-1 border-light opacity-100" style="height: 40px;"></div>
                        <li><a class="text-decoration-none" href="../About Us/about.html">About Us</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-2 col-sm-12">
                    <nav class="navbar">
                        <ul class="navbar-nav text-start navbar-dark">
                            <li class="nav-item">
                                <a class="nav-link" href="../About Us/about.html"><b>Visit Us</b></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="../About Us/about.html">About Us</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="../Support Page/support.html">Contact Us</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="../About Us/about.html">Map View</a>
                            </li>
                        </ul>
                    </nav>
                </div>
    ...
    <script src="lend_script.js"></script>
</body>
