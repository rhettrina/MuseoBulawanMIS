...
function fetchTotalArticles() {
    fetch('https://museobulawan.online/development/admin_mis/src/php/fetchTotalArticles.php')
        .then(response => {                         
            if (!response.ok) {
...
function fetchArticles(sort = 'newest') {
    fetch(`https://museobulawan.online/development/admin_mis/src/php/fetchArticles.php?sort=${sort}`)
        .then(response => {
            if (!response.ok) {
                throw new Error('Network response was not ok: ' + response.statusText);
            }
...
function fetchArticleDetails(articleId) {
    fetch(`https://museobulawan.online/development/admin_mis/src/php/previewArticle.php?id=${articleId}`)
        .then(response => {
            if (!response.ok) {
...
function populateModal(article) {
    const basePath = 'https://museobulawan.online/development/admin_mis/src/uploads/articlesUploads/';
...
function saveArticle() {
    ...
    fetch('https://museobulawan.online/development/admin_mis/src/php/saveArticle.php', {
        method: 'POST',
        body: formData
    })
...
function deleteArticle(articleId) {
    ...
    fetch(`https://museobulawan.online/development/admin_mis/src/php/deleteArticle.php?id=${articleId}`, {
...
function updateArticle(articleId) {
    ...
    fetch(`https://museobulawan.online/development/admin_mis/src/php/previewArticle.php?id=${articleId}`)
        ...
        .then(data => {
            if (data) {
                ...
                const baseUrl = "https://museobulawan.online/development/admin_mis/src/uploads/articlesUploads/";
    ...
    if (saveButton) {
		...
		if(confirm){
            ...
            fetch('https://museobulawan.online/development/admin_mis/src/php/updateArticle.php', {
                method: 'POST',
                body: formData
            })
            .then(response => response.json())
